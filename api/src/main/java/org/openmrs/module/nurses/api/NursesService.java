 ...
 */
package org.openmrs.module.nurses.api;
...
import org.openmrs.module.nurses.NursesConfig;
 ...
 */
public interface NursesService extends OpenmrsService {
	 ...
	 * @throws APIException
	 */
	@Authorized(NursesConfig.MODULE_PRIVILEGE)
	@Transactional
	...
	@Transactional
	List<Nurse> getAllNurses() throws APIException;
